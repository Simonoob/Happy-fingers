...
[ <button className="homeBtn" style={{width:"30%", margin:"0", marginLeft:"2%"}} > Hand anatomy 🍖</button> ](/anatomy/bones)
[ <button className="homeBtn" style={{width:"30%", margin:"0", marginLeft:"2%"}} > Injury overview 🤕</button> ](/injury/injury-mechanics)
[ <button className="homeBtn" style={{width:"30%", margin:"0", marginLeft:"2%"}} > Main takeaway ⌚</button> ](/injury/grips/takeaway)
