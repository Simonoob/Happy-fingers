...
As we have already discussed, the mechanics behind pulley injuries rotate around the amount of load that the pulley has to withstand. Therefore, having a higher BMI (body mass index) might play a factor in how likely you are to get injured, as well as reinjured.
